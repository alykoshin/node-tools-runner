...
import {Actions} from '../runner/lib/types';

import {MicroInterpreter, MicroList} from '../runner/microRunner';
...
function getEvaluate() {
  ...
  let interpreter;
  if (NEW_INTERPRETER) {
    interpreter = new MicroInterpreter({actions});
  } else {
    interpreter = new Runner();
