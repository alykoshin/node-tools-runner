...
exports.Spawn = exports.Cmd = exports.Logger = void 0;
...
class Logger {
    ...
    setNewLevel(levelName) {
        ...
        if (this.lvl < 0)
            this.lvl = LEVELS.indexOf(DEFAULT_LEVEL);
...
class Cmd {
    ...
    async _spawnExecutePromised(cmd, params, options) {
        if (typeof cmd === 'string')
            cmd = stringUtils.splitQuoted(cmd);
