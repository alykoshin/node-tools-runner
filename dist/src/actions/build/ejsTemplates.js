...
// ]
async function ejsTemplates(action, parameters, { id, level, fullConfig, runner }) {
    ...
    for (const currSourcePathname of ejsFiles) {
        ...
        const currTargetFilename = path_1.default.basename(currSourcePathname, path_1.default.extname(currSourcePathname)) + '.html';
